...
public class BasicMessage implements Message {
	...
	public BasicMessage(MessageType type, String senderIp, String receiverIp, int senderPort, int receiverPort) {
		this.type = type;
	...
	public BasicMessage(MessageType type, String senderIp, String receiverIp, int senderPort, int receiverPort, String messageText) {
		this.type = type;
		this.senderIp = senderIp;
		this.receiverIp = receiverIp;
		this.senderPort = senderPort;
